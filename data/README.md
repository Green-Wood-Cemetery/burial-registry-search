...
curl -X "PUT" "https://greenwood-kstyate-arc.searchbase.io/interments" \
  ...
  "mappings": {
    "properties": {
      ...
      "age_hours_transcribed": {
        "type": "text",## create interments index with mappings
curl -X "PUT" "https://greenwood-kstyate-arc.searchbase.io/interments" \
     -H 'Content-Type: application/json' \
     -u 'c4b92b17541b:347b81ba-9d38-443a-90c0-24e9acd9e8a6' \
     -d $'{
  "settings": {
    "index.mapping.ignore_malformed": true
  },
