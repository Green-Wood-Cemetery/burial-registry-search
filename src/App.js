          ...
          <Collapse defaultActiveKey={['33']}>
            ...
            <Panel header="Birthplace" key="4">
              <DataSearch
                ...
                fuzziness={0}
                highlight={false}
                placeholder="Search by birthplace"
                queryFormat="or"
                showFilter={true}
                size={10}
                strictSelection={false}
            ...
            <Panel header="Late residence" key="3">
              <DataSearch
                ...
                fuzziness={0}
                highlight={false}
                placeholder="Search by late residence"
                queryFormat="or"
                showFilter={true}
                size={10}
                strictSelection={false}
            ...
            <Panel header="Place of death" key="2">
              <DataSearch
                ...
                fuzziness={0}
                highlight={false}
                placeholder="Search by place of death"
                queryFormat="or"
                showFilter={true}
                size={10}
                strictSelection={false}
            ...
            <Panel header="Undertaker / Funeral Director" key="11">
              <DataSearch
                ...
                fuzziness={0}
                highlight={false}
                placeholder="Search by Undertaker / Funeral Director"
                queryFormat="or"
                showFilter={true}
                size={10}
                strictSelection={false}
                ...
                URLParams={false}
                title="Undertaker / Funeral Director"
              />
            </Panel>
